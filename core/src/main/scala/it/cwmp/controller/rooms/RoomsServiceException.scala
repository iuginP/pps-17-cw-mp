...
object RoomsServiceException {
  ...
  def unapply(arg: RoomsServiceExceptionWithCode): Option[Int] = Some(arg.httpCode)

  def unapply(arg: RoomsServiceExceptionWithCodeAndMessage): Option[(Int, String)] = Some((arg.httpCode, arg.errorMessage))
