...
trait ObjectDrawer {
  /**
    ...
    */
  def drawCell(cell: ViewCell)(implicit graphicsContex: GraphicsContext): Region = {
    val svg = new SVGPath
  ...
  /**
    ...
    * @return
    */
  private def awtColorToFxColor(awtColor: Color) : javafx.scene.paint.Color = {
    val fxColor: javafx.scene.paint.Color = new javafx.scene.paint.Color(awtColor.getRed / 255.0, awtColor.getGreen / 255.0, awtColor.getBlue / 255.0, awtColor.getAlpha /255.0)
    fxColor
  }
}
