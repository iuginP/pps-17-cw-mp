...
/**
  ...
  */
case class ClientControllerActor(discoveryHost: String, discoveryPort: Int) extends Actor with ParticipantListReceiver with Logging {
  ...
  override def preStart(): Unit = {
    ...
    apiClientActor = context.system.actorOf(Props(classOf[ApiClientActor], discoveryHost, discoveryPort), ApiClientActor.getClass.getName)
